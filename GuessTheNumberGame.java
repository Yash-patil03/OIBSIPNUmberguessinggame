...
public class GuessTheNumberGame {
    ...
    public GuessTheNumberGame(int lowerBound, int upperBound, int maxAttempts) {
    ...
    public static void main(String[] args) {
        ...
        GuessTheNumberGame game = new GuessTheNumberGame(lowerBound, upperBound, maxAttempts);
        game.playGame();
    }
}
